  ...
  processSlash: function(o) {
    if(_.isArray(o)) {
      ...
      switch(command) {
        case 'nick':
          if(isHelp) { 
            responseMsg = '<kbd>/nick newname</kbd>';
        ...
        case 'topic':
          if(isHelp) { 
            responseMsg = '<kbd>/topic password [newtopic]</kbd><br/>';
            responseMsg += 'Change the room topic, clearing the twitter stream and starting anew. Empty topic means we use the sample stream. Requires a password.';
          }
          else {
        ...
        case 'stop':
          if(isHelp) { 
            responseMsg = '<kbd>/stop password</kbd>';
            responseMsg += 'Stop the twitter stream. Requires a password.';
          }
          else {
            responseCls = 'notimplemented';
          }
        ...
        case 'help':
        default:
          responseMsg = 'Commands you can try: <kbd>/nick, /topic, /stop, /help</kbd>. Get help on a specific command with <kbd>/help command</kbd>.';
        break;
